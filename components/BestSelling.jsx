...
const BestSelling = ({ dictionary, lang }) => {
    ...
    return (
        <div className='px-6 my-30 max-w-6xl mx-auto'>
            <Title title={dictionary?.bestSelling || 'Best Selling'} description={`Showing ${products.length < displayQuantity ? products.length : displayQuantity} of ${products.length} products`} href={`/${lang}/shop`} dictionary={dictionary} />
